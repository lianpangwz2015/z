...
<div id="halist" style="display:block;background-color: #000000;height:100%;">
  <ul id="menu">
 <li id="li_1">
  <h1 class="lm_1"><a href="javascript:OpenChanel(1);" class="list_name" hidefocus="true">港澳台频道 <font style="color:#99cc00;font-size:8px">|</font></a></h1>
  <h2 class="lm_2" id="CHT_1" style="display: none"><span class="lm_2"><a href="gatpd.php?id=fhzw" target="_self" hidefocus="true" onMouseOver="ahover('fhzw')" onMouseOut="alink('fhzw')" id="fhzw">港-凤凰卫视中文台 </a><a href="gatpd.php?id=fhxgws" target="_self" hidefocus="true" onMouseOver="ahover('fhxg')" onMouseOut="alink('fhxg')" id="fhxg">港-凤凰卫视香港台 </a><a href="gatpd.php?id=fhzx" target="_self" hidefocus="true" onMouseOver="ahover('fhzx')" onMouseOut="alink('fhzx')" id="fhzx">港-凤凰资讯 </a><a href="gatpd.php?id=xgws" target="_self" hidefocus="true" onMouseOver="ahover('xgws')" onMouseOut="alink('xgws')" id="xgws">港-香港卫视 </a></span></h2>
  </li>
