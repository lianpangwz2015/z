...
<div id="halist" style="display:block;background-color: #000000;height:100%;">
  <ul id="menu">
  <li id="li_1">
	<h1 class="lm_1"><a href="javascript:OpenChanel(1);" class="list_name" hidefocus="true">少儿频道 <font style="color:#99cc00;font-size:8px">|||||</font></a></h1>
    <h2 class="lm_2" id="CHT_1" style="display: none"><a href="srpd.php?id=jykt" target="_self" hidefocus="true" onMouseOver="ahover('jykt')" onMouseOut="alink('jykt')" id="jykt">金鹰卡通</a><a href="srpd.php?id=xdkt" target="_self" hidefocus="true" onMouseOver="ahover('jjkt')" onMouseOut="alink('jjkt')" id="jjkt">炫动卡通<font style="color:#99cc00"></font></a><a href="srpd.php?id=nbsrpd" target="_self" hidefocus="true" onMouseOver="ahover('hhsr')" onMouseOut="alink('hhsr')" id="hhsr">宁波少儿<font style="color:#99cc00"></font></a><a href="srpd.php?id=zjsepd" target="_self" hidefocus="true" onMouseOver="ahover('zjsr')" onMouseOut="alink('zjsr')" id="zjsr">浙江少儿<font style="color:#99cc00"></font></a><a href="srpd.php?id=ymkt" target="_self" hidefocus="true" onMouseOver="ahover('ymkt')" onMouseOut="alink('ymkt')" id="ymkt">优漫卡通</a><a href="srpd.php?id=bjkk" target="_self" hidefocus="true" onMouseOver="ahover('kksr')" onMouseOut="alink('kksr')" id="kksr">卡酷少儿</a></h2>
	</li>
