var jwplayer=function(id){
	var s = {
		'setup':function(o){
			var flashvars = {};
			if(o['playlist'][0].provider){
				flashvars={
					f:"jwplayer/ckplayer/m3u8_dr3.6.swf",
					a: encodeURIComponent(o['playlist'][0].file),
					lv: 1,
					c: 0,
					s: 4,
					p: 1,
					v:100,
					wh:'16:9',
					v:window['init_valume']?window['init_valume']:100,
					hls_live_flushurlcache:isIE()?true:false
				};
			}else{
				flashvars={
					f:encodeURIComponent(o['playlist'][0].file),
					lv: 1,
					c: 0,
					p: 1,
					v:window['init_valume']?window['init_valume']:100,
			...
			CKobject.embedSWF('./jwplayer/ckplayer/ckplayer.swf','myElement','ckplayer_a1','100%','100%',flashvars,params);
		}
	}
	return s;
};
