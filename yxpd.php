...
<div id="halist" style="display:block;background-color: #000000;height:100%;">
  <ul id="menu">
  <li id="li_1">
  <h1 class="lm_1"><a href="javascript:OpenChanel(1);" class="list_name" hidefocus="true">游戏频道 <font style="color:#99cc00;font-size:8px">|||||</font></a></h1>
  <h2 class="lm_2" id="CHT_1" style="display: none"><a href="yxpd.php?id=yxfy" target="_self" hidefocus="true" onMouseOver="ahover('yxfy2')" onMouseOut="alink('yxfy2')" id="yxfy2" >游戏风云</a><a href="yxpd.php?id=fygtv" target="_self" hidefocus="true" onMouseOver="ahover('fygtv')" onMouseOut="alink('fygtv')" id="fygtv" >GTV游戏</a><a href="yxpd.php?id=neotv" target="_self" hidefocus="true" onMouseOver="ahover('NEOTV')" onMouseOut="alink('NEOTV')" id="NEOTV" >英雄联盟职业联赛</a><a href="yxpd.php?id=plu" target="_self" hidefocus="true" onMouseOver="ahover('PLU')" onMouseOut="alink('PLU')" id="PLU" >1006TV英雄联盟</a><a href="yxpd.php?id=scntv" target="_self" hidefocus="true" onMouseOver="ahover('SCNtv')" onMouseOut="alink('SCNtv')" id="SCNtv" >SCNtv英雄联盟频道</a></h2>
  </li>
