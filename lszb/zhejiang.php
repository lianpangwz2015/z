...
//$url="http://r.gslb.lecloud.com/m3u8/".$lid."/desc.m3u8?". $v[1];
//$url="http://live.gslb.letv.com/gslb?stream_id=zhejiangHD_1300&tag=live&ext=m3u8&sign=live_tv&platid=10&splatid=1009&termid=3&playid=1&play=0&ostype=android&hwtype=C1S";
}else{
$url="http://www.letvlive.com";
    header("location:$url");
    exit(1);
...
<meta name="Keywords" content="乐视直播网,网络乐视台,乐视台,乐视直播" />
